...
-   **`reviews``**: _NO ESTOY ENCONTRANDO INFO_
...
-   **`notes`**: Extra information abut the game content. [text]
...
first_cleaned_steam <- first_cleaned_steam %>% select(-detailed_description, -about_the_game, -short_description, -header_image, -notes, -screenshots)

head(first_cleaned_steam)
```
