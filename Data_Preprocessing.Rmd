...
first_cleaned_steam <- first_cleaned_steam %>% select(-detailed_description, -about_the_game, -short_description, -reviews, -header_image, -website, -support_url, -support_email, -metacritic_url, -screenshots, -movies, -user_score, -score_rank, -notes)
...
```{r}
#En caso de empate de precios se queda con el primero
